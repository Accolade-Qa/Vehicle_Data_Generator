...
def generate_institutional_sales(number_of_records: int = 10, output_dir: str | None = None):
    ...
    for index in range(number_of_records):
        ...
        records.append({
            ...
            "VEHICLE_OWNER_REGISTERED_MOBILE": int(field_factory.random_mobile()),
            ...
            "PRIMARY_MOBILE_NUMBER": int(field_factory.random_mobile()),
            "SECONDARY_MOBILE_NUMBER": int(field_factory.random_mobile()),
